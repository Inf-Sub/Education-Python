# №5.4[37] Напишите функцию, которая принимает натуральное число n, в теле
# функции считывает (input) последовательность из n элементов
...
def reverce_print(number):
    string = input('Введите число: ')
    if number == 1:
        return string

    return f'{reverce_print(number - 1)} {string}'
